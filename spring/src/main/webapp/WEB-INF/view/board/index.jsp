		...
		<th>
			<c:choose>
				<c:when test="${param.orderCond =='title_asc' }">
				 	 <a href = "index.do?orderCond=title_desc">제목 ⬆️ </a>
			    </c:when> 
			    <c:when test="${param.orderCond =='title_desc' }">
					  <a href = "index.do?orderCond=title_asc">제목 ⬇️ </a>
				</c:when> 
				<c:otherwise>
		...
		<th>
			<c:choose>
				<c:when test="${param.orderCond =='regdate_asc' }">
				 	 <a href = "index.do?orderCond=regdate_desc">작성일 ⬆️ </a>
			    </c:when> 
			    <c:when test="${param.orderCond =='regdate_desc' }">
					  <a href = "index.do?orderCond=regdate_asc">작성일 ⬇️ </a>
				</c:when> 
				<c:otherwise>
